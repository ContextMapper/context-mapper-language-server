...
function expectAggregateToBeEmpty (aggregate: Aggregate) {
  ...
  expect(aggregate.contentVolatility).toBeUndefined()
  expect(aggregate.availabilityCriticality).toBeUndefined()
  expect(aggregate.consistencyCriticality).toBeUndefined()
  expect(aggregate.storageSimilarity).toBeUndefined()
  expect(aggregate.securityCriticality).toBeUndefined()
  expect(aggregate.securityZone).toBeUndefined()
  expect(aggregate.securityAccessGroup).toBeUndefined()
}
